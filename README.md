...
The program is meant to simulate a storefront that stores product infoirmation like quanirtity in stock and price in MySQL. The app takes in orders from customers and depletes stock from the store's inventory. 
